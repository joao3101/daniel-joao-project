...
type userR struct {
	UserTeams TeamSlice `boil:"UserTeams" json:"UserTeams" toml:"UserTeams" yaml:"UserTeams"`
}
...
var (
	userAllColumns            = []string{"id", "full_name", "email", "hashed_password", "created_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"full_name", "email", "hashed_password"}
	userColumnsWithDefault    = []string{"id", "created_at", "deleted_at"}
...
// UserTeams retrieves all the Team's Teams with an executor via user_id column.
func (o *User) UserTeams(mods ...qm.QueryMod) teamQuery {
...
// LoadUserTeams allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserTeams(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`Teams`),
		qm.WhereIn(`Teams.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.UserTeams = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.UserTeams = append(local.R.UserTeams, foreign)
				if foreign.R == nil {
					foreign.R = &teamR{}
				}
...
// AddUserTeams adds the given related objects to the existing relationships
// of the User, optionally inserting them as new records.
// Appends related to o.R.UserTeams.
// Sets related.R.User appropriately.
func (o *User) AddUserTeams(exec boil.Executor, insert bool, related ...*Team) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.UserTeams = append(o.R.UserTeams, related...)
	}
...
func (o *User) Insert(exec boil.Executor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to populate default values for Users")
	}
...
func (o *User) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to upsert for Users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to retrieve unique values for Users")
	}
