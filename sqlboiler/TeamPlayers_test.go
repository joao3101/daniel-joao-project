...
var (
	teamPlayerDBTypes = map[string]string{`ID`: `integer`, `PlayerID`: `integer`, `TeamID`: `integer`, `CreatedAt`: `timestamp without time zone`, `DeletedAt`: `timestamp without time zone`}
	_                 = bytes.MinRead
)
